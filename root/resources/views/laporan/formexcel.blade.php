...
<div class="col-md-8 col-lg-8 col-md-offset-2">
    <div class="panel panel-bordered panel-primary">
        <div class="panel-heading bg-light-blue-a400">
            <h3 class="panel-title">Ekspor Ke File Excel</h3>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-6 col-lg-6 col-md-offset-3">
                    <form action="{{ url('laporan/excel/download') }}" method="GET" class="form-horizontal" role="form" target="_blank">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                <button type="submit" class="btn btn-round btn-primary btn-block bg-light-blue-a400"><i class="icon md-download" aria-hidden="true"></i> Unduh</button>
                            </div>
                        </div>
                    </form>
                </div>
